...
export class InitialMigration1704067200000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_complaints_tenant" ON "complaints" ("tenantId")`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_complaints_property" ON "complaints" ("propertyId")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_documents_property" ON "documents" ("propertyId")`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "documents" DROP CONSTRAINT "FK_documents_property"`,
    );
    await queryRunner.query(
      `ALTER TABLE "notifications" DROP CONSTRAINT "FK_notifications_user"`,
    );
    await queryRunner.query(
      `ALTER TABLE "complaints" DROP CONSTRAINT "FK_complaints_property"`,
    );
    await queryRunner.query(
      `ALTER TABLE "complaints" DROP CONSTRAINT "FK_complaints_tenant"`,
    );
    await queryRunner.query(
      `ALTER TABLE "payments" DROP CONSTRAINT "FK_payments_lease"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leases" DROP CONSTRAINT "FK_leases_tenant"`,
    );
    await queryRunner.query(
      `ALTER TABLE "leases" DROP CONSTRAINT "FK_leases_property"`,
    );
    await queryRunner.query(
      `ALTER TABLE "properties" DROP CONSTRAINT "FK_properties_landlord"`,
    );
